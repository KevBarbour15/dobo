          ...
          <div className="faq-info-container">
            <ul>
              ...
              <p className="list-item">
                The dinner will take place in Downtown Brooklyn. We will share
                the exact location with you closer to the event date.
              </p>
              ...
              <p className="list-item">
                We're happy to accommodate most allergies and no-pork
                preferences. Please note, our menu primarily features beef,
                chicken, and seafood, which makes vegan or vegetarian options
                challenging.
              </p>
              ...
              <p className="list-item">
                Yes, the ticket price includes the tip.
              </p>
